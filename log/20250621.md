...
```
- ### navicat：
![输入图片说明](/imgs/2025-06-21/JDokLndQctCYfpMA.png)
 - ## **新增商品**
- ### 前端代码：
...
```
- ### 图片展示：
![输入图片说明](/imgs/2025-06-21/dxqGqjlOBow4de49.png)
 - ## **修改商品信息**
 - ### 前端代码：
...
```
- ### 图片展示：
![输入图片说明](/imgs/2025-06-21/w8uFrGXtSJV9yFG3.png)
 - ## **查询商品**
 - ### 前端代码：
1. 查询参数管理
```
...
4. 潜在改进点
  ...
  - ### 图片展示：
  ![输入图片说明](/imgs/2025-06-21/hDRhvT419u71XNQj.png)
