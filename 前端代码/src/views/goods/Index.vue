    ...
    <x-main>
        ...
        <el-row class="search-row">
                            ...
                            <div style="width: 222px">
                                <el-date-picker placeholder="发布时间起始" value-format="YYYY-MM-DD HH:mm:ss" v-model="searchForm.publishtimeL" type="datetime" :shortcuts="shortcuts"/>
                            </div>
                            <span>至</span>
                            <div style="width: 222px">
                                <el-date-picker placeholder="发布时间结束" value-format="YYYY-MM-DD HH:mm:ss" v-model="searchForm.publishtimeR" type="datetime" :shortcuts="shortcuts"/>
                            </div>
                        </div>
                                                                            
            <button class="btn btn-m" type="primary" @click="loadThisPage">查询</button>
            <button class="btn btn-success btn-m" v-if="user && ( user.role.toLowerCase() == 'merchant'   )" @click="onAdd">发布特产</button>
        ...
        <el-table :data="pager.records" style="width: 100%">
            ...
            <template #default="scope">
                <el-button v-if="scope.row.leixFrn" type="primary" text bg @click="leixDetail(scope.row.leix)">{{ scope.row.leixFrn.name }}</el-button>
            </template>
        </el-table-column>
            ...
            <el-table-column fixed="right" label="操作">
                <template #default="scope">
                    ...
                    <button class="btn btn-warn" v-if=" user.role.toLowerCase() == 'merchant'  " @click="onEdit(scope.row.id)">修改</button>
                    <button class="btn btn-error" v-if="  user.role.toLowerCase() == 'merchant'  " @click="onDelete(scope.row.id)">删除</button>
