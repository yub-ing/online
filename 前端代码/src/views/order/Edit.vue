<template>
  <el-form label-position="left" label-width="100px" ref="formRef" :model="form" style="max-width: 600px"
           :rules="rules">
    ...
    <el-form-item label="下单时间" prop="createtime">
      <el-date-picker disabled value-format="YYYY-MM-DD HH:mm:ss" v-model="form.createtime" type="datetime"
                      placeholder="选择时间" :shortcuts="shortcuts"/>
    </el-form-item>
    ...
    <el-form-item v-if="user.role==='merchant'" label="物流单号" prop="wuliu">
      <el-input maxlength="255" v-model="form.wuliu"/>
    </el-form-item>
    <el-form-item v-if="user.role==='merchant'" label="物流信息" prop="wulxx">
      <el-input v-model="form.wulxx" autosize type="textarea"/>
    </el-form-item>
    <el-form-item v-if="user.role!=='merchant'" label="评价" prop="pingj">
